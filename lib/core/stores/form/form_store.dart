...
abstract class _FormStore with Store {
  ...
  void validateUserEmail(String value) {
    if (value.isEmpty) {
      formErrorStore.userEmail = "Username or Email can't be empty";
    } else if (value.length < 3) {
      formErrorStore.userEmail = 'Must be at least 3 characters';
    } else {
  ...
  void validatePassword(String value) {
    if (value.isEmpty) {
      ...
      formErrorStore.password = "Password must be at-least 3 characters";
    } else {
